...
const Home = () => {
  ...
  const MovieSection = ({ title, movies, emoji }) => (
    <section className="mb-12">
      <h2 className="text-gray-900 dark:text-white text-2xl font-bold mb-6 flex items-center gap-2">
        <span className="text-3xl">{emoji}</span>
        {title}
      </h2>
      {movies.length === 0 ? (
        <p className="text-gray-600 dark:text-gray-400 text-center py-8">No hay resultados disponibles</p>
      ) : (
    ...
    <div className="min-h-screen overflow-x-hidden">
      ...
      <section 
        className="relative h-screen flex items-center justify-center overflow-hidden mb-12 w-screen
          bg-gradient-to-b from-purple-100 via-blue-50 to-white
          dark:bg-gradient-to-b dark:from-purple-900/20 dark:via-transparent dark:to-black/80"
        style={{
          marginLeft: 'calc(-50vw + 50%)'
        }}
      >
        {/* Gradient overlay - ajustado para light/dark */}
        <div className="absolute inset-0 
          bg-gradient-to-b from-purple-200/30 via-transparent to-white/80
          dark:bg-gradient-to-b dark:from-purple-900/20 dark:via-transparent dark:to-black/80 
          z-10">
        </div>
        ...
        <div className="relative z-20 text-center px-6 max-w-4xl">
          <h1 className="text-5xl md:text-7xl font-bold text-gray-900 dark:text-white mb-6 animate-fade-in">
            Discover Your Next
            <span className="block bg-gradient-to-r from-purple-600 to-cyan-600 dark:from-purple-400 dark:to-cyan-500 bg-clip-text text-transparent">
              Favorite Movie
            </span>
          </h1>
          <p className="text-gray-700 dark:text-gray-300 text-lg md:text-xl mb-8 max-w-2xl mx-auto">
          ...
          {/* Quick stats */}
          <div className="flex flex-wrap justify-center gap-4 md:gap-8 text-gray-700 dark:text-white/80 text-sm">
      ...
      <div className="px-6 pb-12 max-w-7xl mx-auto">
        ...
        <div className="backdrop-blur-md 
          ...
          rounded-xl p-6 mb-10 shadow-xl">
          ...
          <div className="flex flex-wrap gap-4 items-end">
            <div className="flex flex-col flex-1 min-w-[150px]">
              <label className="text-sm text-purple-700 dark:text-purple-200 mb-2 font-medium">Tipo</label>
              <select
                className="bg-white dark:bg-black/40 backdrop-blur-md 
            ...
            <div className="flex flex-col flex-1 min-w-[200px]">
              <label className="text-sm text-purple-700 dark:text-purple-200 mb-2 font-medium">
            ...
            <div className="flex flex-col flex-1 min-w-[120px]">
              <label className="text-sm text-purple-700 dark:text-purple-200 mb-2 font-medium">Año</label>
              <input
                type="number"
                className="bg-white dark:bg-black/40 backdrop-blur-md 
                  border border-purple-300 dark:border-purple-500/50 
            ...
            <div className="flex gap-2">
              <button
                ...
                className="bg-gradient-to-r from-purple-600 to-cyan-600 hover:from-purple-700 hover:to-cyan-700 
                  dark:from-purple-500 dark:to-cyan-500 dark:hover:from-purple-600 dark:hover:to-cyan-600 
                  disabled:opacity-50 disabled:cursor-not-allowed transition-all px-6 py-2.5 rounded-lg 
                  font-semibold text-white shadow-lg hover:shadow-xl hover:scale-105 active:scale-95"
              >
              ...
              {showFilteredResults && (
                <button
                  ...
                  className="bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 
                    transition-all px-6 py-2.5 rounded-lg font-semibold 
                    text-gray-900 dark:text-white shadow-lg hover:scale-105 active:scale-95"
                >
                  ✖️ Limpiar
                </button>
              )}
          ...
          {showFilteredResults && (
            <div className="mt-4 flex items-center gap-2 text-sm text-purple-700 dark:text-purple-200">
              <span className="font-semibold">Filtros activos:</span>
              <span className="bg-purple-200 dark:bg-purple-500/30 px-3 py-1 rounded-full 
        ...
        {(loading || filterLoading) && (
          <div className="flex justify-center items-center py-20">
            <div className="animate-spin rounded-full h-16 w-16 border-t-4 border-purple-600 dark:border-purple-500"></div>
          </div>
        )}
        ...
        {error && !loading && !filterLoading && (
          <div className="text-center py-10 
            ...
            <p className="text-red-700 dark:text-red-400 text-lg">⚠️ {error}</p>
          </div>
        )}
